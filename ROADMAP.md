...
- [x] Gate 1 raw telemetry prerequisite: local Gate 0 trace emits raw `m_iItemDefinitionIndex` alongside the same pawn/tick AG2 record; zero remains non-qualifying and non-zero is only a schema lookup key
